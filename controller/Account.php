...
class Account extends Controller
{
	...
	private function createGrid()
	{
		...
		$builder->setFormatter(new BasicGridFormatter('account'));
		...
		$builder->addColumn('Bank', 'bank');
		$builder->addColumn('Number', 'number');
		$builder->addColumn('Action', 'id', new ActionColumnFormatter('account', array('edit')));
		return $builder;
	}
	 ...
	 *
	 * @param null|\Entity\Account $entity
	 * @return mixed
	...
	private function createForm($entity = null)
	{
		...
		$builder->setDesigner(new DoctrineDesigner($this->getDoctrine(), 'Entity\Account'));
